...
public class ApplicationContextSameBeanFindTest {
    ...
    void findAllBeanByType() {
        Map<String,MemberRepository> beabsOfType = context.getBeansOfType(MemberRepository.class);
        for (String key : beabsOfType.keySet()) {
            System.out.println("key = " + key + " value = " + beabsOfType.get(key));
        }
        System.out.println("beabsOfType = " + beabsOfType);
        assertThat(beabsOfType.size()).isEqualTo(2);
    }
